    ...
    <section className="jumbotron bg-white">
      ...
      <div className="row">
        <div className="col-sm-6 ">
          ...
          L'étudiant pourra assimiler les enseignements vite et bien en suivant
          le cours magistral, en faisant ses travaux dirigés et ses travaux
          pratiques. L'étudiant de I³T doit pouvoir travailler sous pression. Au
          fil des semestres, son degré de responsabilité augmente de même que
          son niveau de savoir et de savoir-faire.
        </div>
        <div className="col-sm-6">
      ...
      <div className="row">
        ...
        <div className="col-sm-6 ">
          ...
          Sénégal en matière d’enseignement supérieur qui cible particulièrement
          les filières STEM, pour le développement et l’émergence, I³T est une
          offre spécialisée de qualité et de rigueur pour former des ressources
          humaines dans le domaine des nouvelles technologies de l’information
          et des communications, axée sur les Sciences, la Technologie,
          l’Ingénierie et les Mathématiques Appliquées.
        </div>
      </div>
      <hr className="my-4" />
      <div className="row">
      ...
      <div className="row">
        <div className="col-sm-6">
          Titulaires d’un BAC, en formation initiale, vous pouvez intégrer notre
          cycle <strong>LICENCE (Info - Télécoms)</strong> et devenez:
          <ul>
        ...
        <div className="col-sm-6">
          Vous pouvez vous spécialiser en <strong>Licence Informatique</strong>{' '}
          (Système d’Information, Bases de Données et Développement) ou{' '}
          <strong>Télécoms</strong>
          (Techniques et Réseaux de Télécoms et Hautes Fréquences) pour devenir
          :
          <ul>
